...
if [ -d "/etc/squid3/" ]
then
	wget https://github.com/MarleyTelegram/vpssetup/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://github.com/MarleyTelegram/vpssetup/squid2.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid3/squid.conf
	wget https://github.com/MarleyTelegram/vpssetup/payload.txt -O /etc/squid3/payload.txt
	echo " " >> /etc/squid3/payload.txt
	grep -v "^Port 443" /etc/ssh/sshd_config > /tmp/ssh && mv /tmp/ssh /etc/ssh/sshd_config
	echo "Port 443" >> /etc/ssh/sshd_config
	grep -v "^PasswordAuthentication yes" /etc/ssh/sshd_config > /tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
	echo "PasswordAuthentication yes" >> /etc/ssh/sshd_config
	wget https://github.com/MarleyTelegram/vpssetup/scripts/addhost.sh -O /bin/addhost
	chmod +x /bin/addhost
	wget https://github.com/MarleyTelegram/vpssetup/scripts/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget https://github.com/MarleyTelegram/vpssetup/scripts/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget https://github.com/MarleyTelegram/vpssetup/scripts/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	wget https://github.com/MarleyTelegram/vpssetup/scripts/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	wget https://github.com/MarleyTelegram/vpssetup/scripts/mudardata.sh -O /bin/mudardata
	chmod +x /bin/mudardata
	wget https://github.com/MarleyTelegram/vpssetup/scripts/remover.sh -O /bin/remover
	chmod +x /bin/remover
	wget https://github.com/MarleyTelegram/vpssetup/scripts/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget https://github.com/MarleyTelegram/vpssetup/scripts/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget https://github.com/MarleyTelegram/vpssetup/scripts/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	wget https://github.com/MarleyTelegram/vpssetup/scripts/sshmonitor2.sh -O /bin/sshmonitor
...
then
	wget https://github.com/MarleyTelegram/vpssetup/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://github.com/MarleyTelegram/vpssetup/squid.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid/squid.conf
	wget https://github.com/MarleyTelegram/vpssetup/payload.txt -O /etc/squid/payload.txt
	echo " " >> /etc/squid/payload.txt
	grep -v "^Port 443" /etc/ssh/sshd_config > /tmp/ssh && mv /tmp/ssh /etc/ssh/sshd_config
	echo "Port 443" >> /etc/ssh/sshd_config
	grep -v "^PasswordAuthentication yes" /etc/ssh/sshd_config > /tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
	echo "PasswordAuthentication yes" >> /etc/ssh/sshd_config
	wget https://github.com/MarleyTelegram/vpssetup/scripts/2/addhost.sh -O /bin/addhost
	chmod +x /bin/addhost
	wget https://github.com/MarleyTelegram/vpssetup/scripts/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget https://github.com/MarleyTelegram/vpssetup/scripts/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget https://github.com/MarleyTelegram/vpssetup/scripts/2/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	wget https://github.com/MarleyTelegram/vpssetup/scripts/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	wget https://github.com/MarleyTelegram/vpssetup/scripts/mudardata.sh -O /bin/mudardata
